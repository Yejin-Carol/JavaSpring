...
public class ChartController {
	...
	public String august_insertform(Model model) {
		List<ChartDto> list = dao.AugustSelect();
	...
	@RequestMapping(value="September_page")
	public String september_insertform(Model model) {
		List<ChartDto> list = dao.SeptemberSelect();
		
		model.addAttribute("september_list", list);
		
		return "chartFolder/september";
	}
	
	@RequestMapping(value="Piechart_page")
	public String piechart_insertform(Model model) {
		List<ChartDto> list = dao.PiechartSelect();
		
		model.addAttribute("piechart_list", list);
		
		return "chartFolder/piechart";
	}
