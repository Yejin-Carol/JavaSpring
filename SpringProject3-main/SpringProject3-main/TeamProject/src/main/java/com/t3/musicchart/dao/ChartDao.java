...
public class ChartDao {
	...
	public List<ChartDto> SeptemberSelect() {
		List<ChartDto> SeptemberList = sqlsession.selectList("chart.select_september");
		return SeptemberList;
	}

	public List<ChartDto> PiechartSelect() {
		List<ChartDto> PiechartList = sqlsession.selectList("chart.select_piechart");
		return PiechartList;
	}
